...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *submit=[[UIBarButtonItem alloc]initWithTitle:@"相册" style:UIBarButtonItemStylePlain target:self action:@selector(rightBarButtonItenAction)];
...
- (void)scanQRCodeFromPhotosInTheAlbum:(UIImage *)image {
    ...
    for (int index = 0; index < [features count]; index ++) {
        ...
        [_delegate scanSuccessBarcodeJump:scannedResult];
